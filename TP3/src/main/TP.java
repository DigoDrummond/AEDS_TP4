    ...
    public static void menu() throws Exception {
        ...
        switch (sc.nextInt()) {
            ...
            case 5:
                ...
                String ultimaCompactacaoHuff = "TP3/data/dataHuffmanCompressao1.db"; // Caminho para a primeira versão
                                                                                     // da compactação Huffman
                String ultimaCompactacaoLZW = "TP3/data/dataLZWCompressao1.db"; // Caminho para a primeira versão da
                                                                                // compactação LZW
                ...
                if (fileUltimaCompactacao.exists()) {
                    boolean versao = true;
                    while (versao) {
                        ultimaCompactacaoHuff = "TP3/data/dataHuffmanCompressao" + num + ".db"; // Atualiza o caminho
                                                                                                // com a nova versão
                    ...
                    ultimaCompactacaoLZW = "TP3/data/dataLZWCompressao" + num + ".db"; // Atualiza o caminho da versão
                                                                                       // LZW
            ...
            case 6:
                ...
                String versaoCompactacaoHuff = "TP3/data/dataHuffmanCompressao1.db"; // Caminho para a primeira versão
                                                                                     // da compactação Huffman
                ...
                if (file.exists()) {
                    ...
                    while (versao) {
                        versaoCompactacaoHuff = "TP3/data/dataHuffmanCompressao" + numV + ".db"; // Atualiza o caminho
                                                                                                 // com a nova versão
                    ...
                    versaoCompactacaoHuff = "TP3/data/dataHuffmanCompressao" + numV + ".db"; // Atualiza o caminho com a
                                                                                             // versão escolhida
                    String versaoCompactacaoLZW = "TP3/data/dataLZWCompressao" + numV + ".db"; // Atualiza o caminho da
                                                                                               // versão LZW
            ...
            case 7:
                ...
                System.out.println("Digite o padrão que você deseja buscar no texto:");
                ...
                boyer_moore.pesquisaSufixoBom(charArray, padrao.toCharArray());
                ...
                if (!lapide) {
                    ...
                    if (idArq == netflix.getId()) {
                        ...
                        if (tamanhoRegistro >= ba.length) {
                            ...
                            // se id for encontrado mas registro for maior que antigo, marca antigo como
                            // lápide
                            arq.seek(inicioRegistro);
                            arq.writeBoolean(true);// atualiza registro desatualizado para lápide, para evitar conflito
                                                   // na leitura
                        }
                        break; // Sai do loop se o registro foi encontrado, independentemente de atualizado ou
                               // não
